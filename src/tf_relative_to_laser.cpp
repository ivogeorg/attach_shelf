...
void CartApproach::test_relative_tfs() {
  ...
  */
  ...
  std::vector<std::pair<std::string, std::tuple<double, double, double>>> v;
  v.push_back(std::make_pair("tf_1", std::make_tuple(1.0, 1.0, 0.0)));
  v.push_back(std::make_pair("tf_2", std::make_tuple(1.0, -1.0, 0.0)));
  v.push_back(std::make_pair("tf_3", std::make_tuple(2.0, 1.0, PI_ / 2.0)));
  v.push_back(std::make_pair("tf_4", std::make_tuple(2.0, -1.0, -PI_ / 2.0)));
