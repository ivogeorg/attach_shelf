 ...
 */
class CartPickUp : public rclcpp::Node {
private:
...
CartPickUp::CartPickUp()
    : Node("cart_pick_up_service_server_node"),
      ...
      srv_{this->create_service<PickUpCart>(
          "cart_pick_up",
          std::bind(&CartPickUp::service_callback, this, _1, _2),
          rmw_qos_profile_services_default, cb_group_)},
      scan_sub_{this->create_subscription<sensor_msgs::msg::LaserScan>(
          "scan", 10,
          std::bind(&CartPickUp::laser_scan_callback, this, _1),
          topic_pub_sub_options_)},
      odom_sub_{this->create_subscription<nav_msgs::msg::Odometry>(
          "odom", 10,
          std::bind(&CartPickUp::odometry_callback, this, _1),
          topic_pub_sub_options_)},
      vel_pub_{
      ...
      listener_timer_{this->create_wall_timer(
          100ms, std::bind(&CartPickUp::listener_cb, this),
          cb_group_)},
      tf_broadcaster_{std::make_shared<tf2_ros::TransformBroadcaster>(this)},
      broadcaster_timer_{this->create_wall_timer(
          100ms, std::bind(&CartPickUp::broadcaster_cb, this),
          cb_group_)} {
 ...
 */
void CartPickUp::service_callback(
 ...
 */
void CartPickUp::move(double dist_m, MotionDirection dir,
                                 double speed) {
...
void CartPickUp::turn(double angle_rad, double speed) {
...
CartPickUp::segment(std::vector<int> &v, const int threshold) {
 ...
 */
void CartPickUp::broadcaster_cb() {
 ...
 */
std::tuple<double, double, double>
CartPickUp::solve_sas_triangle(double l_side, double r_side,
                                          double sas_angle) {
...
int main(int argc, char **argv) {
  ...
  auto node = std::make_shared<CartPickUp>();
