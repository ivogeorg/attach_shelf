...
def generate_launch_description():
    ...
    tf_relative_to_laser_dynamic_test_node = Node(
        package='attach_shelf', executable='tf_relative_to_laser_dynamic_test_node',
        output='screen', name='tf_relative_to_laser_dynamic_test_node', emulate_tty=True,
